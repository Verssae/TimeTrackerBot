...
intents.add(Intents.FLAGS.GUILD_MEMBERS, Intents.FLAGS.GUILD_MESSAGE_TYPING,Intents.FLAGS.GUILD_MESSAGES, Intents.FLAGS.GUILD_EMOJIS_AND_STICKERS, Intents.FLAGS.GUILDS, Intents.FLAGS.GUILD_PRESENCES)

const client = new Client({ intents: intents })


const token = process.env.TOKEN
var inviteLink = "https://discord.gg/vRqSPPcx";
...
client.on("typingStart", function(channel, user){
    console.log(`${user ? user.tag : "_"} has started typing`);
});
